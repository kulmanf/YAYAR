        ...
        internal void Initialize(QCAlgorithm algorithm, FkuMode fkuMode)
        {
            ...
            switch (fkuMode)
            {
                case FkuMode.InteractiveBrokers:
                    Symbols = symbols;
                    algorithm.SetStartDate(
                        FkuConfiguration.startYear, 
                        FkuConfiguration.startMonth,
                        FkuConfiguration.startDay);
                    algorithm.SetEndDate(
                        FkuConfiguration.endYear, 
                        FkuConfiguration.endMonth, 
                        FkuConfiguration.endDay);
                    break;
